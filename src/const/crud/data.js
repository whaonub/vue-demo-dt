export const tableData = [{
    ...
    number: 12,
    type: '0',
    stars: 'https://gitee.com/dt_chutao/kb/badge/star.svg?theme=white',
    git: 'https://gitee.com/dt_chutao/kb',
    address: "https://gitee.com/dt_chutao",
    info: '新云核心是基于Spring Cloud、OAuth2.0，使用Vue前后分离的开发平台,支持账号、 短信、 SSO等多种登录。 ',
  },
  {
    username: "smallwei",
    name: "smallwei",
